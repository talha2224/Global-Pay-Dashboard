...

            {
                showDetails && (
                    <div className="fixed top-0 left-0 w-screen h-screen inset-0 bg-black bg-opacity-50 flex justify-center items-center transition-opacity duration-300 ease-in-out" onClick={() => setshowDetails(false)}>
                        ...
                        <div className="bg-white rounded-lg shadow-lg p-6 w-[100%] h-[90vh] overflow-y-auto max-w-md transform scale-95 opacity-0 animate-fade-in" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className="overflow-x-auto mt-5">
                                <table className="border-collapse overflow-x-auto w-full">
                                    <thead>
                                        <tr className='text-sm text-[#8F8F8F]'>
                                            <th className="border-b py-2 pr-4 text-left text-sm font-normal text-nowrap">Contact Name</th>
                                            <th className="border-b py-2 pr-4 text-left text-sm font-normal text-nowrap">Reg No</th>
                                    ...
                                    <tbody>
                                        {[1]?.map((data) => (
                                            <tr key={data} className="border-b hover:bg-gray-100 text-sm font-normal">
                                                <td className="py-2 pr-4 flex items-center text-sm font-normal text-nowrap">James Stuart</td>
                                                <td className="py-2 pr-4 text-sm font-normal text-nowrap text-[#1BD8BA]">070845</td>
                                                <td className="py-2 px-4 text-sm font-normal text-nowrap"><h1 className='text-sm text-start '>Feb 2 - 2025 19:40</h1></td>
                                                <td className="py-2 px-4 text-sm font-normal text-nowrap"><h1 className='text-[#037AE0] text-start'>113.2.183.254</h1></td>
                                            </tr>
                                        ))}
                            ...
                            <div className="overflow-x-auto mt-5">
                                <table className="border-collapse overflow-x-auto w-full">
                                    <thead>
                                        <tr className='text-sm text-[#8F8F8F]'>
                                            <th className="border-b py-2 pr-4 text-left text-sm font-normal text-nowrap">Phone Number</th>
                                            <th className="border-b py-2 px-4 text-left text-sm font-normal text-nowrap">Contact Email</th>
                                            <th className="border-b py-2 px-4 text-left text-sm font-normal text-nowrap">Website</th>
                                            <th className="border-b py-2 px-4 text-left text-sm font-normal text-nowrap">Company</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {[1]?.map((data) => (
                                            <tr key={data} className="border-b hover:bg-gray-100 text-sm font-normal">
                                                ...
                                                <td className="py-2 pr-4 text-sm font-normal text-nowrap text-[#FF0500]">(480) 555-0103</td>
                                                <td className="py-2 px-4 flex items-center text-sm font-normal text-nowrap text-[#1BD8BA]">johndoe@gmail.com</td>
                                                <td className="py-2 px-4 text-sm font-normal text-nowrap"><h1 className='text-sm text-start '>--</h1></td>
                                                <td className="py-2 pr-4 text-sm font-normal text-nowrap">
                            ...
                            <div className=' flex items-center gap-x-3 mt-4'>
                                <button onClick={() => { setshowDetails(false); setfinal(true) }} className='px-6 py-2 rounded-full bg-[#037AE0] text-white text-sm'>Approve</button>
                                <button onClick={() => { setshowDetails(false); }} className='px-10 py-2 rounded-full bg-[#FCECEC] text-[#DB413E] text-sm'>Reject</button>
                            </div>
                    ...
                    <div className="fixed top-0 left-0 w-screen h-screen inset-0 bg-black bg-opacity-50 flex justify-center items-center transition-opacity duration-300 ease-in-out" onClick={() => setshowDetails(false)}>
                        ...
                        <div className="bg-white rounded-lg shadow-lg p-6 w-[100%] h-[90vh] overflow-y-auto max-w-md transform scale-95 opacity-0 animate-fade-in" onClick={(e) => e.stopPropagation()}>
                            ...
                            <div className='flex justify-between items-center'>
                                ...
                                <div></div>
                                <RxCross2 onClick={() => setfinal(false)} className=' cursor-pointer' />
                            </div>

                            <div className='h-[95%] flex justify-center items-center flex-col'>
                                <MdPhotoSizeSelectActual className='text-[#8F8F8F] mb-1 text-2xl'/>
                                <p className='text-[#8F8F8F] text-center'>Business Registration Certificate</p>
                            </div>
