                        ...
                        <div className="bg-white w-[25rem] p-5 rounded-xl">
                            ...
                            <div className="flex justify-between items-center">
                                <div>
                                    ...
                                    <p className="text-sm mt-1 text-[#8f8f8f]">Sed ut perspiciatis unde </p>
                                </div>

                                <div onClick={() => setinitialModel(false)} className=" cursor-pointer text-[#8f8f8f]">
                                    <RxCross1 />
                                </div>
                            </div>
                            ...
                            <Link to={"/"} className='flex items-center gap-x-2 cursor-pointer mt-3'>
