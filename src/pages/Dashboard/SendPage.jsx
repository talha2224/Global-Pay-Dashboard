...
import MasterCard from '../../assets/dashboard/admin/logo.png'
        ...
        <div className='flex-1 overflow-x-auto'>
            ...
            <div className="mt-5 flex items-start gap-x-6 flex-wrap">
                ...
                <div className="min-w-[20rem] bg-white rounded-md p-3 mt-3">
                    ...
                    <button onClick={() => setShowDepositModel(true)} className="text-sm text-[#00D725] w-[100%] px-5 py-2 rounded-full bg-[#E5FBE0] mt-3">Send</button>
                </div>
                ...
                showDepositModel && (
                    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-40">
                        ...
                        <div className="bg-white w-[25rem] p-5 rounded-xl">
                            ...
                            <p className="text-sm mt-1 text-[#8f8f8f]">P2P transaction</p>

                            <div className="bg-gray-100 mt-5 p-3 rounded-md">
                                <p className="text-base font-medium">Send To</p>
                                <div className="flex justify-between items-center mt-3 bg-gray-50 p-2 rounded-md">
                                    <input type="text" name="" id="" className="w-[100%] outline-none bg-transparent" placeholder="User ID 3030303hhgnxxyy" />
                                </div>

                                <p className="text-base font-medium mt-2">From</p>
                            ...
                            <button onClick={() => { setShowDepositModel(false); setShowQrCode(true) }} className="bg-blue-600 text-white w-full h-12 flex justify-center items-center mt-4 rounded-full">Send</button>
                        </div>
                    </div>
                )
            }
